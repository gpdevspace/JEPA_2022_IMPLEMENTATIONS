...
from experiments.step06_latent_var_jepa.model import JEPA
...
def plot_training_curves(history: list[dict], out_path: Path) -> None:
    ...
    if loss_type == "vicreg":
        ...
        latent_penalty = [h["latent_penalty"] for h in history]
        ...
        ax.plot(epochs, latent_penalty, color="#8c564b", linewidth=2, label="Latent Penalty")
        ax.set_xlabel("Epoch", fontsize=11)
