...
class JEPAModel(nn.Module):
    ...
    def __init__(self, embedding_dim: int = 128, hidden_dim: int = 512, image_size: int = 64):
        super().__init__()
    ...
    def forward(
        ...
        pred_loss = F.mse_loss(s_y_pred, s_y)
        ...
        if return_recon:
            ...
            combined_loss = 0.99 * pred_loss + 0.01 * recon_loss
